    ...
    return(
        ...
        <>
            <div className="personal-section row">
                ...
                <div className="name">dorisa shehi</div>
                ...
                <div className="sub-section">
                    <form>
                        <div className="form-group">
                            ...
                            <input type="text" className="form-input" name="name" id="name" placeholder="Enter Your First and Last Name"/>
                        </div>
                        <div className="form-group">
                            <label htmlFor="job-descr">Technology</label>
                            <input type="text" className="form-input" name="job-descr" id="job-descr" placeholder="Enter Job Title"/>
                        </div>
                        ...
                        <div className="row-group">
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className="form-input" name="phone" id="phone" placeholder="Enter Phone"/>
                            </div>
                        </div>

                        <div className="form-group">
                            <label htmlFor="address">Address</label>
                            <input type="text" className="form-input" name="address" id="address" placeholder="City, Country"/>
                        </div>
                    </form>
                </div>
