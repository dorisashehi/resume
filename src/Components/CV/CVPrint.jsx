            ...
            <View style={styles.row}>
                ...
                <View style={styles.sectionDescr}>
                    {experience.map((experienceItem, index) => {
                        ...
                        const date = (experienceItem.exp_start_date || 'MM/YEAR') + ' - ' + (experienceItem.exp_end_date || 'MM/YEAR');
                        const responsibilities = experienceItem.exp_responsibilities || '<ul><li>For example: Part of a 7 person team delivering a product serving 1,500 users, releasing updates every 2 weeks, on a codebase with more than 150,000 lines of code, 100 classes, 15 tables.</ul>';
            ...
            <View style={styles.row} >
                ...
                <View style={styles.sectionDescr}>
                    {projects.map((project, index) => {
                        ...
                        const work = project?.project_works || '<ul><li>Cover your project, team/ solo work, quantify and call out notable things like size of projects, number of users, etc.</li></ul>'; // Summary sanitized or default value
